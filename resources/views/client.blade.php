...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Client | Tasya Beauty</title>
   ...
   <body>
            ...
            <nav class="navbar navbar-light bg-light justify-content-between">
               ...
               <form class="form-inline ">
                  <div class="login_text">
                     <ul>
                        <li><a href="/l"><img src="images/user-icon.png"></a></li>
      ...
      <div class="customer_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  <h1 class="customer_taital">Apa yang Kostumer Kastakan???</h1>
               </div>
            </div>
